...
_.extend(qbd, {
	...
	init: function(options) {
        ...
        this.DEBUG && console.log("Loading QBD(): %o %o %o", qbd, qbd.$el, qbd.options)
	...
	show: function(conf, params) {
		...
		if (conf.url && d3[responseType]) {
            ...
            d3[responseType](url, function(response) {
                this.DEBUG && console.log("Loaded QB data: %s %o %o", conf.id, conf, response);
